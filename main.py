        ...
        try:
            ...
            for chunk in chunks:
                for item in chunk:
                    ...
                    invoice.PRZ_TYPE = get_prize_type(item['PRIZE_TYPE'])
...
def get_invoice_data_02(EINVOICE_01, EINVOICE_02, PRINT_TIME):
    INV_DATA = []
        ...
        try:
            ...
            for item in row:
                ...
                if item['IS_PRINT'] == "Y":
                    ...
                    invoice.DATA_2 = "學思行股份有限公司"
                    invoice.DATA_3 = "24342999"
                    invoice.DATA_4 = ""
                    invoice.DATA_5 = "讀冊會員載具"
                    ...
                    invoice.DATA_14 = prize_start[0:3] + "年" + prize_start[3:5] + "月" + prize_start[5:7] + "日" + "至" + prize_end[0:3] + "年" + prize_end[3:5] + "月" + prize_end[5:7] + "日"
...
def famiport_002():
    ...
    try:
        ...
        for inv in INV_DATA:
            ...
            TEMP_INV_DETAIL = get_invoice_data_02(EINVOICE_01, EINVOICE_02, PRINT_TIME)
...
# curl -H "Content-Type: application/x-www-form-urlencoded; charset=big5" -X POST -d "PRZ_003_01=<?xml version=\"1.0\" encoding=\"big5\"?><SEND_DATA><TRAN_NO>18C00000052</TRAN_NO><TEN_CODE>009979</TEN_CODE><PRINT_TIME>20191209130201</PRINT_TIME><INV_DATA><EINVOICE_01>XC</EINVOICE_01><EINVOICE_02>76945226</EINVOICE_02></INV_DATA><INV_DATA><EINVOICE_01>XC</EINVOICE_01><EINVOICE_02>76945227</EINVOICE_02></INV_DATA></SEND_DATA>" https://service.taaze.tw/famiport/prz_002
# curl -H "Content-Type: application/x-www-form-urlencoded; charset=big5" -X POST -d "PRZ_003_01=<?xml version=\"1.0\" encoding=\"big5\"?><SEND_DATA><TRAN_NO>18C00000052</TRAN_NO><TEN_CODE>009979</TEN_CODE><PRINT_TIME>20191209130201</PRINT_TIME><INV_DATA><EINVOICE_01>LW</EINVOICE_01><EINVOICE_02>47312903</EINVOICE_02></INV_DATA><INV_DATA><EINVOICE_01>XC</EINVOICE_01><EINVOICE_02>76945227</EINVOICE_02></INV_DATA></SEND_DATA>" http://127.0.0.1:8080/famiport/prz_002
